...
function initialize(){
  ...
  classnumber = location.href.split("/")[5];
  console.log(user);
...
//firebaseに送信用メソッド
 function send(){
   ...
   console.log(user);
   var userRef = new Firebase("https://system-5b20e.firebaseio.com/"+classnumber+"/"+user);
   var cell_number = [];
   var cell_position_x = [];
   var cell_position_y = [];
   var cell_color =[];
 ...
 var ref = new Firebase("https://system-5b20e.firebaseio.com/"+classnumber+"/"+user_name);
      /*
    ...
    // var user_name=[];本来の場所
     ...
     var cell_attribute_updown6=[];
       ...
       */
       ...
       var ref = new Firebase("https://system-5b20e.firebaseio.com/"+classnumber);
       var ff=[];
     ref.on("value",function(snapshot){
...
function py(){
  ...
  xhr.open("GET","/api/change/"+classnumber+"/"+user);
  xhr.send();
}
